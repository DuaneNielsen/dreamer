import torch
from data import collate_action_observation
from mentalitystorm.atari import ActionEncoderDataset
...
dataset = ActionEncoderDataset(r'c:\data\SpaceInvaders-v4\rl_raw')
